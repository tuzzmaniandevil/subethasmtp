...
public interface AuthenticationHandler {
     ...
     * another auth() call with the client's response.
     * <p>
     ...
     * <p>
     * AuthenticationHandlers are associated with a single authentication
     * exchange. If the exchange is stopped (ie fails) and is restarted, a new
     ...
     * <p>
     * AuthenticationHandlers do not need to handle the "*" cancel response;
     ...
     * @param clientInput The client's input, eg "AUTH PLAIN
     * dGVzdAB0ZXN0ADEyMzQ="
