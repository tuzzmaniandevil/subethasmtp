...
public class CRLFTerminatedReader extends Reader {
     ...
     * @param charsetName the String name of a supported charset. "ASCII" is
     * common here.
     ...
     * characters are not returned with the String, but if either CR or LF
     * appears in the text in any other sequence it is returned in the String
     * like any other character. Some characters at the end of the stream may be
     * lost if they are in a "line" not terminated by CRLF.
     *
     * @return either a String containing the contents of a line which must end
     * with CRLF, or null if the end of the stream has been reached, possibly
