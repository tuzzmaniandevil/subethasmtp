...
public interface MessageContext {
     ...
     * or EHLO command, or null if neither of these commands were received yet.
     * Note that SubEthaSMTP (along with some MTAs, but contrary to RFC 5321)
     * accept mail transactions without these commands.
     */
     ...
     * {@link javax.net.ssl.SSLSocket#setNeedClientAuth(boolean) setNeedClientAuth(true)}
     * on the created socket.
     *
     * @return an ordered array of peer certificates, with the peer's own
     * certificate first followed by any certificate authorities, or null when
