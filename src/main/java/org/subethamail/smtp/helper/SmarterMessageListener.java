...
public interface SmarterMessageListener {
    ...
    /**
     * Called once for every RCPT TO during a SMTP exchange. Each accepted
     * recipient returns a Receiver which will have its deliver() mehtod called
     * later.
     *
     * @param from is a rfc822-compliant email address.
     * @param recipient is a rfc822-compliant email address.
     *
     * @return A Receiver if the listener wants delivery of the message, null if
     * the message is not to be accepted.
     */
    ...
    public interface Receiver {
        ...
        /**
         * When message data arrives, this method will be called for every
         * recipient this listener accepted.
         *
         * @param data will be the smtp data stream, stripped of any extra '.'
         * chars. The data stream is only valid for the duration of this call.
         *
         * @throws TooMuchDataException if the listener can't handle that much
         * data. An error will be reported to the client.
        ...
        /**
         * Called at the end of the SMTP exchange, even if no data was
         * delivered.
         */
        public void done();
    }
